...
function setupQMethods(instance: ComponentInternalInstance) {
  ...
  instance.getCurrentPage = () => {
    ...
    if (typeof getRealPageInstance === 'function') {
      return getRealPageInstance(pId)
    }
  }
  instance.createSelectorQuery = () => {
    if (
      typeof qts === 'undefined' ||
      typeof qts.createSelectorQuery !== 'function'
    ) {
  ...
  instance.createIntersectionObserver = options => {
    if (
      typeof qts === 'undefined' ||
      typeof qts.createIntersectionObserver !== 'function'
    ) {
